...
const activities = [
  ['How purposeful did today feel?', 'How much did you feel like you were moving with purpose today?', 'purpose', '#9b5b4d'],
  ['Did it reach beyond you?', 'Did something you did connect to another person, a group, or something bigger than you?', 'scope', '#806d52'],
  ['Which way were you moving?', 'Did you feel a sense of direction, even if it changed during the day?', 'orientation', '#657b68'],
  ['What mattered to you today?', 'Did a topic, idea, person, or problem keep pulling your attention today?', 'content', '#6f5577'],
